...
class SignUpAuthTests(BaseAccountsTestCase):
    ...
    def test_signup_into_timeout(self):
        ...
        self.assertContains(response, "The code you supplied is incorrect. Please try again.")
...
class LoginAuthTests(BaseAccountsTestCase):
    ...
    def test_login(self):
        ...
        # Does it contain the correct error?
        self.assertContains(response, "There is already an active code for your account. Please wait until it expires before generating a new one.")
