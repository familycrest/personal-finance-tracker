...
const deleteGoalsViewURL =
  document.querySelector("#delete-goals-url").dataset.url;
...
const acct_goal_add_cancel_btn = document.querySelector(
  "#acct-goal-add-cancel"
);
...
const acct_goal_edit_cancel_btn = document.querySelector(
  "#acct-goal-edit-cancel"
);
...
const cat_goal_edit_cancel_btn = document.querySelector(
  "#cat-goal-edit-cancel"
);
