...
# import views from the current folder
...
urlpatterns = [
    ...
    path("transactions/", personal_finance_tracker_app_views.transactions, name="transactions"),

    # transaction list redirect
    path("transactions/list/", personal_finance_tracker_app_views.transactions_list, name="transactions_list"),

    # reports page redirect
    path("reports/", personal_finance_tracker_app_views.reports, name="reports"),
