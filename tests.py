...
class TestAllPagesAvailable(LiveServerTestCase):
    ...
    def check_page_available(self, path, expected_text, tag):
    ...
    def test_home_page(self):
        self.check_page_available("/", "Welcome to My Finance Tracker!", "h1")

    def test_signup_page(self):
        self.check_page_available("/signup/", "Sign Up", "h2")

    def test_login_page(self):
        self.check_page_available("/login/", "Log In", "h2")

    def test_logout_page(self):
        self.check_page_available("/logout/", "You have successfully logged out.", "h2")

    def test_dashboard_page(self):
        self.check_page_available("/dashboard/", "Dashboard", "h1")
